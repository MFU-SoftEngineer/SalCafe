...
<script type="text/javascript">
		jQuery(document).ready(function($) {
			...
			$(".menu-info").hover(function(){
				$(this).css({cursor:"url(images/ico/buy_popular.ico),auto"})
		  	},function(){
		...
		function goMenu(id,type){
			window.location.href="menu.jsp?id="+id + "&type="+type;
		}
</script>
<!--//end-smoth-scrolling-->
</head>
...
<%@ page import="java.util.*" %>
			...
			<!-- script-for-menu -->
			 <script>
			   $( "span.menu" ).click(function() {
				 $( "ul.nav1" ).slideToggle( 0, function() {
				 // Animation complete.
				  });
				 });
			</script>
	...
	<div class="about-menu">
		<div class="container">
			<h3 class="title1 wow fadeInDown animated" data-wow-delay=".5s">Popular Beverage</h3>
			<p class="data wow fadeInLeft animated" data-wow-delay=".5s">Choose from our variety of flavors.</p>
			<div class="menu-row wow zoomIn animated" data-wow-delay=".5s">
				...
				<div class="col-md-6 menu-right scrollbar scrollbar1">
					<%
						...
						HashMap<Integer,List<Item>> itemHashMap = itemService.queryAllItemBySales(6);
						List<Item> itemList1 = itemHashMap.get(1);
						int j = 0;
						for(Item item:itemList1){
							j++;
					%>
							<div class="menu-info" id="<%=item.getItemId() %>" onclick="goMenu(this.id,'1')">
			...
			<h3 class="title1 wow fadeInDown animated" data-wow-delay=".5s">Popular Snack</h3>
			<div class="menu-row wow zoomIn animated" data-wow-delay=".5s">
				<div class="col-md-6 menu-left">
				...
				<div class="col-md-6 menu-right scrollbar scrollbar1">
					<%
						List<Item> itemList2 = itemHashMap.get(2);
						int i = 0;
						for(Item item:itemList2){
							i++;
					%>
							<div class="menu-info" id="<%=item.getItemId() %>" onclick="goMenu(this.id,'2')">
								<div class="menu-list-left">
		...
		<div class="container">
			...
			<div class="col-md-4 footer-left wow fadeInDown animated" data-wow-delay=".5s">
				...
				<ul>
					...
					<li><a href="gallery.html"><i class="glyphicon glyphicon-chevron-right"></i> Menu</a></li>
